...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(NotValidCardIdException.class)
	protected ResponseEntity<Object> handleNotValidCardIdException(NotValidCardIdException ex) {
		LOGGER.error("NotValidCardIdException : ", ex.getMessage());
